...
impl ::protobuf::Message for Ping {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.late {
            my_size += ::protobuf::rt::value_size(3, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.lost {
            my_size += ::protobuf::rt::value_size(4, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.resync {
            my_size += ::protobuf::rt::value_size(5, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.udp_packets {
            my_size += ::protobuf::rt::value_size(6, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.tcp_packets {
...
impl ::protobuf::Message for ServerSync {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.max_bandwidth {
            my_size += ::protobuf::rt::value_size(2, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.welcome_text {
            my_size += ::protobuf::rt::string_size(3, &value);
        };
...
impl ::protobuf::Message for ChannelState {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.description_hash {
            my_size += ::protobuf::rt::bytes_size(10, &value);
        };
        for value in &self.max_users {
...
impl ::protobuf::Message for UserState {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.plugin_context {
            my_size += ::protobuf::rt::bytes_size(12, &value);
        };
        for value in &self.plugin_identity {
        ...
        for value in &self.comment_hash {
            my_size += ::protobuf::rt::bytes_size(16, &value);
        };
        for value in &self.texture_hash {
...
impl ::protobuf::Message for UserList_User {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.last_seen {
            my_size += ::protobuf::rt::string_size(3, &value);
        };
        for value in &self.last_channel {
            my_size += ::protobuf::rt::value_size(4, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
...
impl ::protobuf::Message for UserStats {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.from_client {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        for value in &self.from_server {
            let len = value.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        };
        for value in &self.udp_packets {
...
impl ::protobuf::Message for ServerConfig {
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.message_length {
            my_size += ::protobuf::rt::value_size(4, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.image_message_length {
            my_size += ::protobuf::rt::value_size(5, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.max_users {
            my_size += ::protobuf::rt::value_size(6, *value, ::protobuf::wire_format::WireTypeVarint);
